...
user-invocable: true
argument-hint: "perfil de riesgo (opcional: conservative | moderate | aggressive)"
---
...
1. Copiar el archivo `assets/template.html` a `dashboard/public/data/index.html` (en el directorio de instalación del skill).
2. Verificar si el puerto 3420 está en uso: `lsof -i :3420`
3. Si ya corre en 3420, no iniciar nuevo servidor (el usuario solo refresca el browser).
4. Si no está en uso, iniciar en background desde el directorio del skill: `python3 -m http.server 3420 --directory dashboard/public/data &`
5. Esperar 1 segundo: `sleep 1`
...
- Si Python no está disponible, abrir directamente el archivo `dashboard/public/data/index.html` en el browser.

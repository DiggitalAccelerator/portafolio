...
>
> Ahora ejecuta `/portafolio` para generar tu primer reporte de mercados. El reporte se guarda en `output/report.html` — ábrelo directo en tu browser, sin servidor ni instalaciones adicionales.
>
> **¿Quieres recibirlo automáticamente de lunes a viernes a las 9am?** Ejecuta este comando en tu terminal:
> ```
> (crontab -l 2>/dev/null; echo "0 9 * * 1-5 /usr/local/bin/claude -p 'analizar mercados'") | crontab -
> ```
